...
public class PsicologoController {
    ...
    @GetMapping("/psicologos-count")
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    public List<EspecialidadPsicologoDTO> getContarPsicologoByEspecialidad() {
        List<EspecialidadPsicologoDTO> psicologoEspecialidadDTOs = aS.reporte01st();
